...
import com.example.openpaytest.databinding.AdpSmallMoviesBinding
import com.example.openpaytest.utils.Constants
import com.example.openpaytest.utils.MethodsHandler

class AdpSmallMovies : RecyclerView.Adapter<AdpSmallMovies.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = AdpSmallMoviesBinding.inflate(inflater, parent, false)
    ...
    class ViewHolder(private val binding: AdpSmallMoviesBinding) : RecyclerView.ViewHolder(binding.root) {
